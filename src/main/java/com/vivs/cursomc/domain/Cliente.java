...
public class Cliente implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7306007012634018158L;
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	private Integer id;
	private String nome;
	
	@Column(unique=true) //sem repetição de email
...
//	private TipoCliente tipo;
	...
	//sempre que buscar um cliente do banco de dados automaticamente serão buscados os perfis também
