...
import com.vivs.cursomc.domain.PagamentoComCartao;
...
import com.vivs.cursomc.repositories.EstadoRepository;
...
import com.vivs.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		Produto p8 = new Produto(null, "Cadeira", 90.00);
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "vivsfrick@yahoo.com", "18068104097", TipoCliente.PESSOAFISICA,
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2,
				java.time.LocalDate.of(2017, 10, 20), null);
